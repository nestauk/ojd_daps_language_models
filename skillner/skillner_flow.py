        ...
        if self.hf_push:
            ...
            metadata = {
                ...
                "performance": {
                    ...
                    "skill_p": ents_per_type_dict["SKILL"]["precision"],
                    "skill_r": ents_per_type_dict["SKILL"]["recall"],
                    "skill_f": ents_per_type_dict["SKILL"]["f1"],
                    "experience_p": ents_per_type_dict["EXPERIENCE"]["precision"],
                    "experience_r": ents_per_type_dict["EXPERIENCE"]["recall"],
                    "experience_f": ents_per_type_dict["EXPERIENCE"]["f1"],
                    "benefit_p": ents_per_type_dict["BENEFIT"]["precision"],
                    "benefit_r": ents_per_type_dict["BENEFIT"]["recall"],
                    "benefit_f": ents_per_type_dict["BENEFIT"]["f1"],
