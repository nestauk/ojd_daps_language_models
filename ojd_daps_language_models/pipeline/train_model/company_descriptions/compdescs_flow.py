...
from compdescs_flow_utils import tokenizer, model, CONFIG, preprocess_function
...
class CompDescFlow(FlowSpec):
    ...
    def get_labelled_data(self):
        ...
        training_data_path = os.path.join(
            "prinz-green-jobs", CONFIG["training_data_path"]
        )
    ...
    def split_labelled_data(self):
        ...
        non_comp_descs = (
            ...
            .sample(sample, random_state=CONFIG["random_seed"])
        ...
        train = training_data_equal.drop(columns="job_id").sample(
            frac=self.train_frac, random_state=CONFIG["random_seed"]
        )
